...
namespace Einsteins_Riddle
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            Console.WriteLine("     3. These five owners drink certain" +
                " tyoe of beverage, smoke a certain brand of cigar and keep a certain pet.");
            ...
            Console.WriteLine();
            Console.WriteLine("Enstein wrote this ridle this century. He said that 98% of the world " +
                "could not solve it.");
            Console.WriteLine();
        ...
        private static void PrintSolution()
        {
            for (int i = 0; i < 5; i++)
            {
                Console.WriteLine($"In the {houses[i]} hose lives the {nationalities[i]}. " +
                    $"He drinks {drinks[i]}, smokes {cigarettes[i]} and has {pets[i]} as a pet.");
            }
        }
        ...
        private static void GenerateHints()
        {
            ...
            hints[13] = $"the {nationalities[0]} lives next to the blue house";
        ...
        static void Shuffle(Random rand)
        {
            for (int i = 0; i < 5; i++)
            {
                ...
                int randomDrink = rand.Next(0, drinks.Length - i);
